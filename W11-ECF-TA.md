...
![interrupt](./res/image/slides.assets/interrupt.png){.mx-auto}
...
![trap](./res/image/slides.assets/trap.png){.mx-auto}
...
![fault](./res/image/slides.assets/fault.png){.mx-auto}
...
![common_exception](./res/image/slides.assets/common_exception.png){.mx-auto}
...
![syscall](./res/image/slides.assets/syscall.png){.mx-auto.h-50}
...
![concurrent](./res/image/slides.assets/concurrent.png){.mx-auto}
...
![private_address_space](./res/image/slides.assets/private_address_space.png){.mx-auto}
...
![context_switch](./res/image/slides.assets/context_switch.png){.mx-auto.h-60}
...
![fork](./res/image/slides.assets/fork.png){.mx-auto.h-70}
...
![fork_example_1](./res/image/slides.assets/fork_example_1.png){.mx-auto.h-100}
...
![fork_example_2_code](./res/image/slides.assets/fork_example_2_code.png){.mx-auto}
...
![fork_example_2_ans](./res/image/slides.assets/fork_example_2_ans.png){.mx-auto}
...
![wait_example](./res/image/slides.assets/wait_example.png){.mx-auto}
...
![argv_and_envp](./res/image/slides.assets/argv_and_envp.png){.mx-auto.h-60}

</div>

<div>

![user_stack](./res/image/slides.assets/user_stack.png){.mx-auto}
...
![sig_handler](./res/image/slides.assets/sig_handler.png){.mx-auto}
...
![process_group](./res/image/slides.assets/process_group.png){.mx-auto}
...
![sig_handler_double](./res/image/slides.assets/sig_handler_double.png){.mx-auto.h-60}
...
- [Note Link](https://github.com/Yaenday/WalkerCH-ICS-Slides/blob/main/res/document/Exceptional-Control-Flow%20Note.html)

![PixPin_2024-11-18_23-30-05](./res/image/slides.assets/PixPin_2024-11-18_23-30-05.png){.w-150}
